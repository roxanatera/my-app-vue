...
import AlertsGroup from './components/AlertsGroup.vue'
...
const products = [
  {
    ...
    price: 29.99,
    image: 'https://via.placeholder.com/300x200/3B82F6/FFFFFF?text=Producto+1',
  },
  {
    id: 2,
    name: 'Producto 2',
    ...
    price: 39.99,
    image: 'https://via.placeholder.com/300x200/10B981/FFFFFF?text=Producto+2',
  },
  {
    id: 3,
    name: 'Producto 3',
  ...
  <div id="app" class="min-h-screen bg-gray-100">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
      ...
      <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 class="text-2xl font-semibold text-gray-800 mb-4">Panel de Ofertas</h2>
        ...
        <div class="mt-6">
          <PromoBanner :slides="slides" :intervalMs="4000" />
        </div>
      </div>
